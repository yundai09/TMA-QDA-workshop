...
Let's go to this [folder](https://github.com/yundai09/TMA-QDA-workshop/tree/gh-pages/modules/workflow%20%26%20methodology/documents) where our files are stored, download them, and upload them to Taguette one by one (I know, I know ...). This may take a while.
...
When uploading the files, if the original file name is too long, Taguette won't accept that and you have to rename the file. It is recommended that you follow one naming convention to name the files. For example, we named the files "date_subject_university".
